...
namespace AmericanView.View.Controllers
{
    ...
    public class RegistrarController : Controller
    {
        ...
        public RegistrarController() //AuthenticationService<CustomUserAccount> authSvc,UserAccountService<CustomUserAccount> userSvc, IUsuarioUIDevolucaoFacade usrDevolucao)
        {
            //_authSvc = authSvc;
            //_userSvc = userSvc;
