namespace Keeptrue.Conciliador.View
{
    ...
    using UI.Application.Contracts;
    using UI.Application.Bindings;
    using Permissoes.Application.Contracts;
    using Permissoes.Application.Bindings;
    using Comum.Application.Contracts;
    using Comum.Application.Bindings;
    using Relatorios.Application.Contracts;
    using Relatorios.Application.Bindings;
    using Validacoes.Application.Contracts;
    using Validacoes.Application.Bindings;
    using Cruzamento.Application.Bindings;
    using Cruzamento.Application.Contracts;
    using Apuracoes.Application.Contracts;
    using Apuracoes.Application.Bindings;
